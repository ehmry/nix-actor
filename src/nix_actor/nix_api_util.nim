...
proc setting_get*(context: NixContext; key: cstring; value: cstring; n: cint): nix_err {.
    nix_api_util.}
proc setting_set*(context: NixContext; key: cstring; value: cstring): nix_err {.
    nix_api_util.}
proc version_get*(): cstring {.nix_api_util.}
proc err_msg*(context: NixContext; ctx: NixContext; n: ptr cuint): cstring {.
    nix_api_util.}
proc err_info_msg*(context: NixContext; read_context: NixContext;
                   value: cstring; n: cint): nix_err {.nix_api_util.}
proc err_name*(context: NixContext; read_context: NixContext; value: cstring;
               n: cint): nix_err {.nix_api_util.}
proc err_code*(read_context: NixContext): nix_err {.nix_api_util.}
proc set_err_msg*(context: NixContext; err: nix_err; msg: cstring): nix_err {.
    nix_api_util.}