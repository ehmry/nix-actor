...
proc expr_eval_from_string*(context: NixContext; state: State; expr: cstring;
                            path: cstring; value: Value): nix_err {.nix_api_expr.}
proc value_call*(context: NixContext; state: State; fn: Value; arg: Value;
                 value: Value): nix_err {.nix_api_expr.}
proc value_force*(context: NixContext; state: State; value: Value): nix_err {.
    nix_api_expr.}
proc value_force_deep*(context: NixContext; state: State; value: Value): nix_err {.
    nix_api_expr.}
proc state_create*(context: NixContext; searchPath: cstringArray; store: Store): State {.
    nix_api_expr.}
